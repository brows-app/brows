...
//    /// </example>
//    internal class Win32ContextMenu : NativeWindow {
//        #region Constructor
//        /// <summary>Default constructor</summary>
//        public Win32ContextMenu() {
...
//        private void InvokeCommand(IContextMenu oContextMenu, uint nCmd, string strFolder, int x, int y) {
...
//                    InvokeCommand(_oContextMenu, nDefaultCmd, arrFI[0].DirectoryName, Control.MousePosition.X, Control.MousePosition.Y);
//                }
...
//        public void ShowContextMenu(FileInfo[] files, int x, int y) {
//            // Release all resources first.
//            ReleaseAll();
...
//        /// <param name="pointScreen">Where to show the menu</param>
//        public void ShowContextMenu(DirectoryInfo[] dirs, int x, int y) {
//            // Release all resources first.
//            ReleaseAll();
...
//                if (nSelected != 0) {
//                    InvokeCommand(_oContextMenu, nSelected, _strParentFolder, x, y);
//                }
//            }
//            catch {
//                throw;

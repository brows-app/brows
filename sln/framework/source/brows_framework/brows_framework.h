#ifndef BROWS_FRAMEWORK_H
#define BROWS_FRAMEWORK_H
...
#ifdef      brows_framework_IMPORT
#define     brows_framework                        brows_DLLIMPORT
#endif

#ifdef      brows_framework_EXPORT
#define     brows_framework                        brows_DLLEXPORT
#endif

#ifndef     brows_framework
#define     brows_framework                        brows_EXTERN_C
#endif
...
brows_framework    brows_ERROR                     brows_init(void);
brows_framework    brows_ERROR                     brows_log(brows_LogLevel, const char*, ...);
brows_framework    void                            brows_logged(brows_ERROR(*)(brows_LogLevel, const char*));
brows_framework    void                            brows_logging(int32_t(*)(brows_LogLevel));

brows_framework    int32_t                         brows_canceled(brows_Canceler*);

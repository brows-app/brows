...
namespace Domore.IO {
    public static class DirectoryInfoExtension {
        ...
        public static DirectoryInfoAsyncEnumerable EnumerateFileSystemInfosAsync(this DirectoryInfo directoryInfo, string searchPattern, EnumerationOptions enumerationOptions) {

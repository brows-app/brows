...
namespace Domore.Runtime.Win32 {
    [Flags]
    public enum IEIFLAG : uint {
        ASYNC = 0x0001,      // (deprecated) ask the extractor if it supports ASYNC extract (free threaded)
        ...
        REFRESH = 0x0400       // returned from the extractor if it would like to have Refresh Thumbnail available
    }
}

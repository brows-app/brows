...
brows_ssh   int64_t                                     brows_ssh_Conn_get_host                 (brows_ssh_Conn*);
brows_ssh   int32_t                                     brows_ssh_Conn_get_host_family          (brows_ssh_Conn*);
brows_ssh   int32_t                                     brows_ssh_Conn_get_port                 (brows_ssh_Conn*);
brows_ssh   brows_ssh_Username                          brows_ssh_Conn_get_username             (brows_ssh_Conn*);
brows_ssh   brows_ERROR                                 brows_ssh_Conn_set_host                 (brows_ssh_Conn*, int64_t);
brows_ssh   brows_ERROR                                 brows_ssh_Conn_set_host_family          (brows_ssh_Conn*, int32_t);
brows_ssh   brows_ERROR                                 brows_ssh_Conn_set_port                 (brows_ssh_Conn*, int32_t);

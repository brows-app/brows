...
namespace Brows.Commands {
    internal static class DrawImageEncoder {
        ...
        /// </summary>
        private static IReadOnlyDictionary<string, Guid> ContainerFormat =>
            _ContainerFormat ?? (
            _ContainerFormat = new Dictionary<string, Guid> {
        ...
        private static IReadOnlyList<BitmapEncoder> Encoders =>
            _Encoders ?? (
            _Encoders = new List<BitmapEncoder>(ContainerFormat.Values
        ...
        private static IReadOnlyDictionary<string, Guid> Encoder =>
            _Encoder ?? (
            _Encoder = Encoders

...
internal static class FileSystemInfoData {
    ...
    public abstract class ImageBase : FileSystemInfoData<object>, IExport {
        protected abstract Task<object> GetSource(FileSystemEntry entry, CancellationToken cancellationToken);

        protected sealed override Task<object> GetValue(FileSystemEntry entry,
    ...
    public abstract class Definition<T> : FileSystemInfoData<T> {
        ...
        protected sealed override async Task<T> GetValue(FileSystemEntry entry,
                                                         Action<T> progress,
...
internal abstract class FileSystemInfoData<T> : EntryDataExport<FileSystemEntry, T> {

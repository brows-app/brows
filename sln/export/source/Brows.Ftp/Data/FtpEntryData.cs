...
internal static class FtpEntryData {
    ...
    public sealed class Icon : FtpEntryData<object> {
        protected sealed override async Task<object> GetValue(FtpEntry entry,
    ...
    public abstract class Definition<T> : FtpEntryData<T> {
        ...
        protected sealed override Task<T> GetValue(FtpEntry entry,
                                                   Action<T> progress,
...
internal abstract class FtpEntryData<T> : EntryDataExport<FtpEntry, T> {
